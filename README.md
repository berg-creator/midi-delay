...
Зелёная целиком, в том числе «Plugin state restoration», которая до сессии 24 мигала
на `Tempo Sync`: галка хранила сырое число хоста, и плагин теперь сворачивает его в 0/1
после загрузки состояния. Разбор: [docs/ISSUES.md](docs/ISSUES.md) `## [54]`.
